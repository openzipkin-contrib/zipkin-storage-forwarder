...
The Docker image for zipkin-storage-forwarder is a layer over zipkin, including only the [../module] and
configuration settings.

As zipkin-storage-forwarder is a contrib project, Docker images only push to `ghcr.io`.
